      ...
      <div className="relative z-10 flex flex-col items-center justify-between h-full p-8">
        ...
        <div className="w-full max-w-4xl mx-auto mt-8">
          <div className="backdrop-blur-xl bg-black/20 border border-white/10 rounded-2xl px-8 py-4 flex items-center justify-between">
            <span className={`text-white/95 font-medium text-lg flex items-center ${ppEditorialNew.className}`}>
              <svg 
                width="40" 
                height="30" 
                viewBox="0 0 400 300" 
        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full px-8">
          <div className="mb-12">
            <span className={`text-[6rem] sm:text-[8rem] md:text-[10rem] font-light text-white tracking-tight ${ppEditorialNew.className}`}>coeus</span>
          </div>
          
          <h2 className="text-xl sm:text-2xl md:text-3xl text-white/85 font-light mb-12 text-center">Mass Interviewer Platform</h2>
